...
import (
	...
	fmtparser "github.com/zasdaym/text/internal/format"
...
func (x *extracter) seedEndpoints() error {
	pkgInfo := x.iprog.Package("github.com/zasdaym/text/message")
	if pkgInfo == nil {
		return errors.New("pipeline: github.com/zasdaym/text/message is not imported")
	}
